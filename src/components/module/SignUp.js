...
const signUpBtn = ()=>{
    ...
    return (
        <>
                ...
                <CommonTextInput placeholder={"Password"} txtStyle={styles.email} onChangeText={(text) => setPasswordInput(text)} value={passwordInput} refValue={ref => passwordRef = ref} keyboardType={Style.Constants.KB_TYPE_DEFAULT} onSubmitEditing={() => coonfirmPasswordRef.focus()}/>
                <CommonTextInput placeholder={"Confirm password"} txtStyle={styles.email} onChangeText={(text) => setConfirmPasswordInput(text)} value={confirmPasswordInput} refValue={ref => coonfirmPasswordRef = ref} keyboardType={Style.Constants.KB_TYPE_DEFAULT} onSubmitEditing={() => coonfirmPasswordRef.blur()}/>
