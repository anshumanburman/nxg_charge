...
const CommonHeader = (props) => {
    const { headerTitle,onPress,tintColor, menuIcon } = props;
...
{menuIcon ? 
    <Image style={{ width: 25, height: 25, resizeMode: 'contain',marginLeft: 15,tintColor  }} source={require('../../../assets/images/menu.png')} />
:
